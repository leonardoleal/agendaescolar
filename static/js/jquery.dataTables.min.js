...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processando...",sLengthMenu:"Exibir _MENU_ registros",sZeroRecords:"Nenhum registro encontrado",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 a 0 de 0 registros",sInfoFiltered:"(filtrado do total de _MAX_ registros)",sInfoPostFix:"",sSearch:"Procurar:",sUrl:"",oPaginate:{sFirst:"Início",sPrevious:"Voltar",sNext:"Avançar",sLast:"Fim"}};
